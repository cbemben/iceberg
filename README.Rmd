...
Details of this Kaggle challenge can be found [here](https://www.kaggle.com/c/titanic), the challenge is to accurately predict whether a passenger survived the shipwreck or not. The response variable is binary (1 or 0) since a passenger cannot partially survive. This document will use the [Stan](https://mc-stan.org/) programming language and logistic regression to attack the challenge.
...
simple_model <- stan_model('~/projectrepos/titanic/inst/stan/mod001.stan')
```
