...
```{r}
class_mod <- titanic::age_gender_class_stan(age=train[train_idx,'Age'],
...
```{r}
class_predict <- titanic::age_gender_class_stan(age=train[train_idx,'Age'],
                                    pclass=train[train_idx,'Pclass'],
                                    sex=2,
                                    sex_idx=as.integer(train[train_idx,'Sex']),
                                    survived=train[train_idx,'Survived'],
...
#write.csv(test[,c("PassengerId","Survived")] ,file="~/projectrepos/titanic/inst/extdata/predict_age_class.csv", row.names = FALSE)
```
...
```{r engine='bash', comment='', echo=FALSE}
cat ~/projectrepos/titanic/inst/stan/age_gender_class_model.stan
```
