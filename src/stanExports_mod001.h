...
namespace model_mod001_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mod001");
    reader.add_event(38, 36, "end", "model_mod001");
    return reader;
}
#include <stan_meta_header.hpp>
class model_mod001
  : public stan::model::model_base_crtp<model_mod001> {
private:
        int N;
        vector_d y;
public:
    model_mod001(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_mod001_namespace::model_mod001";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(normal_log<propto__>(mu, 20, 2));
            current_statement_begin__ = 30;
            lp_accum__.add(uniform_log<propto__>(sigma, 0, 100));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_mod001_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            stan::math::assign(y_rep,normal_rng(mu, sigma, base_rng__));
            // validate, write generated quantities
            current_statement_begin__ = 35;
            vars__.push_back(y_rep);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
...
typedef model_mod001_namespace::model_mod001 stan_model;
#ifndef USING_R
