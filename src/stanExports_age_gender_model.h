...
namespace model_age_gender_model_namespace {
using std::istream;
using std::string;
...
class model_age_gender_model
  : public stan::model::model_base_crtp<model_age_gender_model> {
private:
        int N;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_age_gender_model_namespace::model_age_gender_model";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_age_gender_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_age_gender_model_namespace::model_age_gender_model stan_model;
#ifndef USING_R
