...
#include "stanExports_mod002_logit_hier.h"

RCPP_MODULE(stan_fit4mod002_logit_hier_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_mod002_logit_hier")
