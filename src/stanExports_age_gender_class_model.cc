...
#include "stanExports_age_gender_class_model.h"

RCPP_MODULE(stan_fit4age_gender_class_model_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_age_gender_class_model")
