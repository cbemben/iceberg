...
RcppExport SEXP _rcpp_module_boot_stan_fit4mod002_logit_mod();
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_rcpp_module_boot_stan_fit4mod002_logit_mod", (DL_FUNC) &_rcpp_module_boot_stan_fit4mod002_logit_mod, 0},
    {"_rcpp_module_boot_stan_fit4mod002_logit_hier_mod", (DL_FUNC) &_rcpp_module_boot_stan_fit4mod002_logit_hier_mod, 0},
    {NULL, NULL, 0}
};

RcppExport void R_init_titanic(DllInfo *dll) {
