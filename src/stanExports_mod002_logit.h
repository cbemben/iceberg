...
namespace model_mod002_logit_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mod002_logit");
    reader.add_event(46, 44, "end", "model_mod002_logit");
    return reader;
}
#include <stan_meta_header.hpp>
class model_mod002_logit
  : public stan::model::model_base_crtp<model_mod002_logit> {
private:
        int N;
        vector_d x;
        std::vector<int> y;
        ...
        vector_d x_new;
public:
    model_mod002_logit(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_mod002_logit_namespace::model_mod002_logit";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "x_new", "vector_d", context__.to_vec(N_new));
            x_new = Eigen::Matrix<double, Eigen::Dynamic, 1>(N_new);
            vals_r__ = context__.vals_r("x_new");
            pos__ = 0;
            size_t x_new_j_1_max__ = N_new;
            for (size_t j_1__ = 0; j_1__ < x_new_j_1_max__; ++j_1__) {
                x_new(j_1__) = vals_r__[pos__++];
            }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(bernoulli_logit_log<propto__>(y, add(alpha, multiply(beta, x))));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_mod002_logit_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                stan::model::assign(y_rep, 
                            ...
                            bernoulli_logit_rng((alpha + (beta * get_base1(x, n, "x", 1))), base_rng__), 
            ...
            for (int n = 1; n <= N_new; ++n) {
                ...
                stan::model::assign(y_new, 
                            stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                            bernoulli_logit_rng((alpha + (beta * get_base1(x_new, n, "x_new", 1))), base_rng__), 
...
typedef model_mod002_logit_namespace::model_mod002_logit stan_model;
#ifndef USING_R
